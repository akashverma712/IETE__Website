...
export default function Home() {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
      ...
      {/* ✅ Gradient Overlay (THIS MAKES IT VISIBLE) */}
      <div className="absolute inset-0 bg-gradient-to-br from-black via-slate-900 to-black opacity-70 z-10 pointer-events-none" />
